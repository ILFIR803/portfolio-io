         ...
         <div className="container">
            <div className="contact__wrap">
               ...
               <div className="contact__wrapper">
                  ...
                  <h2 className="contact__subtitel subtitle">Свяжитесь со мной</h2>
                  <span className="divider"></span>
                  
                     <span className="contact__text">Любым удобным для вас способом:</span>
                     ...
                     <span className="contact__text">Или оставьте ваши данные и я сам вам напишу:</span>
                     <form action="#" className="contact__forms">
                        ...
                        <div className="contact__triggers">
                           ...
                           <div className="contact__policy">
                              ...
                              <span className="contact__policy">
                                 Я согласен(а) с &nbsp;
