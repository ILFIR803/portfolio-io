   ...
   return <>
      ...
      <div className="header">
         <div className="container">
            ...
            <a href='#content'><button className="btn btn__active" >Про меня</button></a>
            <a href="#portfolio"><button className="btn ">Портфолио</button></a>

         </div>
         <div className="social-panel">
            <span className="socialpanel__vertical">Социальные сети - </span>
         ...
         <div className="humburger" onClick={() => setMenuActive(!menuActive)}>
